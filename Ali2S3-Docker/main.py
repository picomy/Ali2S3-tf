...
ali_key = secretDict["ali_access_key"]
ali_secret = secretDict["ali_secret_access_key"]
s3_aws_ak = secretDict["s3_access_key_id"]
s3_aws_sk = secretDict["s3_secret_access_key"]
...
## Update the s3 ak&sk
conf["oss"]["access_key_id"] = ali_key
conf["oss"]["secret_access_key"] = ali_secret
conf["s3"]["access_key_id"] = s3_aws_ak
conf["s3"]["secret_access_key"] = s3_aws_sk
...
subprocess.run(["/usr/bin/rclone", "copyto", srcpath, dstpath, "-P", "--transfers", "16", "--checkers", "16"])
